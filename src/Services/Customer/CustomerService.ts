...
class CustomerService {
    ...
    async getAllCustomers(): Promise<CustomerDTO[]> {
        try {
            ...
            const customers = Array.isArray(response.data.content) ? response.data.content : response.data.content.customers; // Adjust this line based on your API response structure
